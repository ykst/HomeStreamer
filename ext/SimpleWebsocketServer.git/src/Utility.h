...
#ifndef _SimpleWebsocketServer_Utility_h_
#define _SimpleWebsocketServer_Utility_h_
...
#define CGRECT2STR(rect) NSPRINTF(@"(x: %.2f, y:%.2f, w:%.2f, h:%.2f)", rect.origin.x, rect.origin.y, rect.size.width, rect.size.height)
